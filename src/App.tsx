...
function App() {
  ...
  const afichesList = [
    ...
    {
      num: 14,
      title: 'Derechos Humanos - Art. 14',
      file: 'afiche-14.jpg',
      subtitle: 'Art. 14',
    },
    {
      num: 15,
      title: 'Derechos Humanos - Art. 15',
      file: 'afiche-15.jpg',
      subtitle: 'Art. 15',
    },
    {
      num: 16,
      title: 'Derechos Humanos - Art. 16',
      file: 'afiche-16.jpg',
      subtitle: 'Art. 16',
    },
    {
  ...
  const nextAfiche = () => {
    setSelectedAficheIndex(
      (prev) => (prev + 1) % afichesList.length
    );
  };
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-2xl">
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Educando y empoderando a las comunidades
                colombianas sobre sus derechos
                fundamentales. Parte de la organización
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                La Fundación capítulo Unidos por los
                Derechos Humanos Colombia, y su movimiento
                "Unidos haremos de Colombia y el mundo un
                mejor lugar para vivir", se consolidan como
                un eje de articulación ciudadana para la
                protección de la dignidad humana.
              </p>

              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                A través de una red de apoyo estratégica,
                que integra organizaciones aliadas y
                mecanismos de veeduría en diversos ámbitos,
                garantizamos una presencia efectiva en la
                defensa y educación de los Derechos Humanos.
              </p>

              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Nuestra labor trasciende la teoría: somos
                una plataforma de incidencia real que,
                mediante la cooperación técnica y el
                empoderamiento social, trabaja para que las
                garantías fundamentales sean el pilar de la
                convivencia en nuestro territorio y un
                referente de transformación global.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
                Consejo Territorial de Paz, Reconciliación y
                Convivencia
              </h2>
              ...
              <p className="text-sky-50 text-lg mb-4 leading-relaxed">
                Hacemos parte del Consejo Territorial de
                Paz, Reconciliación y Convivencia de
                Santiago de Cali
                <span className="font-bold text-white">
                  {' '}
                  en representación de la Fundación Árbol
                  Fuente de Vida
                </span>
                , trabajando conjuntamente por la
                construcción de paz, la reconciliación y la
                convivencia ciudadana en nuestra ciudad.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg text-yellow-50 max-w-3xl mx-auto">
              Capítulo Colombia autorizado oficialmente.
              Utilizamos los logos, colores y materiales
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-white/10 backdrop-blur border-white/20">
              ...
              <CardContent>
                <p className="text-blue-100 leading-relaxed">
                  Educar y empoderar a las comunidades
                  colombianas sobre sus derechos humanos
                  fundamentales, utilizando los recursos
                  oficiales de la organización internacional
                  Unidos por los Derechos Humanos, para
            ...
            <Card className="bg-white/10 backdrop-blur border-white/20">
              ...
              <CardContent>
                <p className="text-blue-100 leading-relaxed">
                  Ser el referente principal en educación de
                  derechos humanos en Colombia, alcanzando
                  todas las regiones del país con materiales
                  educativos de calidad, formando una
                  ciudadanía informada que defienda
                  activamente los derechos humanos para
                  todos.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Trabajamos junto a diversas organizaciones
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Fortalecer el tejido social generando
                  confianza y bienestar de todos los
                  sectores de la sociedad, ofreciendo
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Organización no gubernamental dedicada a
                  la protección y promoción de los derechos
                  humanos, trabajando por la justicia social
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Veeduría ciudadana facultada por la Ley
                  850 de 2003 para el control social,
                  vigilancia y seguimiento de la gestión
                  pública, promoviendo la transparencia y el
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Sindicato de Acción Comunal de Colombia -
                  Organización que promueve el
                  fortalecimiento de las organizaciones
                  comunales y la participación ciudadana en
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Revertir la decadencia moral de la
                  sociedad al restaurar la confianza y
                  honestidad a través de la distribución
                  amplia del libro "El Camino a la
                  Felicidad", una guía basada en el sentido
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Proporcionar información basada en hechos
                  acerca de las drogas para que las personas
                  puedan tomar decisiones informadas y vivir
                  una vida libre de drogas, mediante
                  educación y prevención efectiva.
                </p>
      ...
      <section id="videos" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Contenido audiovisual oficial de Unidos por los Derechos Humanos en espanol
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Video completo con los 30 derechos humanos en espanol latino',
                videoId: 'Lp6wEaivQVY',
              },
              {
              ...
              },
              {
                ...
                description: 'Todos tienen los mismos derechos sin distincion de ningun tipo',
                videoId: 'n0WfKHaNfA0',
              },
              {
              ...
              },
              {
                ...
                description: 'Nadie estara sometido a esclavitud ni a servidumbre',
                videoId: '4-a4sEZ1fK0',
              },
              {
                title: 'Derecho #5: Ninguna Tortura',
                description: 'Nadie sera sometido a torturas ni a penas o tratos crueles',
                videoId: '_8YfmW6Jv4U',
              },
            ].map((video, index) => (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              El poder que no duerme - Informacion y actualizaciones de nuestra fundacion.
            </p>
          </div>
          <Card className="border-0 shadow-xl overflow-hidden">
            ...
            <CardContent className="p-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full hover:opacity-90 transition-opacity font-medium"
              >
      ...
      <section id="donaciones" className="py-20 bg-gradient-to-br from-green-50 to-emerald-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Tu aporte nos permite continuar educando y empoderando comunidades sobre sus derechos humanos.
            </p>
          </div>
      ...
      <section id="afiliacion" className="py-20 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Formulario de Afiliacion</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              ...
              {formEnviado ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6">
                    Se ha abierto tu correo con los datos. Envia el mensaje para completar tu afiliacion.
                  </p>
                ...
                <form onSubmit={handleFormSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea name="motivo" value={formData.motivo} onChange={handleFormChange} required rows={3}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="Cuentanos tu motivacion para unirte..."></textarea>
                  </div>
      ...
      <section id="formatos" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Formatos</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                description: 'Formulario para solicitar alianza estrategica con nuestra fundacion',
                format: 'PDF',
              ...
              {
                title: 'Formato Derecho de Peticion',
                description: 'Modelo para ejercer el derecho de peticion constitucional',
                format: 'PDF',
                url: '/formato-derecho-peticion.pdf',
              },
              {
                title: 'Formato Observacion Procedimiento',
                description: 'Formato para observar procedimientos administrativos',
                format: 'PDF',
                url: '/formato-observacion-procedimiento.pdf',
              },
              {
                title: 'Modelo de Peticion',
                description: 'Ejemplo practico de derecho de peticion',
                format: 'PDF',
                url: '/modelo-de-peticion-1.pdf',
              },
              {
                title: 'Modelo de Tutela',
                description: 'Ejemplo practico de accion de tutela',
                format: 'PDF',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-yellow-100 rounded-full mb-4">
              ...
              <span className="text-yellow-700 text-sm font-medium">Capacitacion</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Capacitate</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md overflow-hidden">
              <div className="h-48 bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center">
                <img src="/logo-uhr.png" alt="Unidos por los Derechos Humanos" className="w-32 h-32 object-contain" />
              </div>
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a href="https://www.unidosporlosderechoshumanos.mx/" target="_blank" rel="noopener noreferrer">
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md overflow-hidden">
              <div className="h-48 bg-gradient-to-br from-green-600 to-green-800 flex items-center justify-center">
                <img src="/logo-camino-felicidad.jpg" alt="El Camino a la Felicidad" className="w-32 h-32 object-contain rounded-lg" />
              </div>
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-green-600 font-medium">Gratuito</span>
                  <a href="https://www.elcaminoalafelicidad.mx/course/" target="_blank" rel="noopener noreferrer">
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md overflow-hidden">
              <div className="h-48 bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center">
                <img src="/logo-drug-free-world.jpg" alt="Mundo Libre de Drogas" className="w-32 h-32 object-contain rounded-lg" />
              </div>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Curso sobre Drogas</h3>
                <p className="text-gray-600 text-sm mb-4">
                  Informacion veraz sobre los efectos de las drogas. Curso educativo gratuito.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-green-600 font-medium">Gratuito</span>
                  <a href="https://www.vidasindrogas.org/" target="_blank" rel="noopener noreferrer">
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Cursos gratuitos de la Organizacion Panamericana de la Salud sobre derechos humanos y salud.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-green-600 font-medium">Gratuito</span>
            ...
            {/* Aula Virtual Defensoria del Pueblo */}
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md overflow-hidden">
              <div className="h-48 bg-gradient-to-br from-indigo-600 to-purple-700 flex items-center justify-center">
                <div className="text-center text-white">
                  ...
                  <p className="text-lg font-bold">Defensoria del Pueblo</p>
                </div>
              </div>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Aula Virtual Defensoria del Pueblo</h3>
                <p className="text-gray-600 text-sm mb-4">
                  Plataforma gratuita de la Defensoria del Pueblo de Colombia para capacitacion en derechos humanos.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-green-600 font-medium">Gratuito</span>
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Escuela Superior de Administracion Publica - Cursos gratuitos de formacion en derechos humanos y administracion publica.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-green-600 font-medium">Gratuito</span>
      ...
      <section id="recursos" className="py-20 bg-gradient-to-br from-blue-900 to-indigo-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Recursos Oficiales</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description: 'Capacitacion gratuita',
      ...
      <section id="contacto" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Contactanos</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Estamos aqui para ayudarte. Escribenos o visitanos en nuestras oficinas.
            </p>
          </div>
              ...
              <Card className="border-0 shadow-md">
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">Correo Electronico</h3>
              ...
              <Card className="border-0 shadow-md">
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">Telefono / WhatsApp</h3>
                      <p className="text-gray-600">301 673 3819</p>
                      <a href="https://web.whatsapp.com/send?phone=573016733819" target="_blank" rel="noopener noreferrer"
                ...
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="https://www.instagram.com/capitulounidosddhhcol/" target="_blank" rel="noopener noreferrer" className="text-pink-600 hover:underline">
                ...
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="https://www.tiktok.com/@capitulounidosddhhcol" target="_blank" rel="noopener noreferrer" className="text-black hover:underline">
                        @capitulounidosddhhcol
                      </a>
                    </div>
                  </div>
              ...
              <CardContent className="p-8">
                ...
                <form className="space-y-4">
                  ...
                  <div>
                    ...
                    <input type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Sobre que nos quieres contactar?" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Mensaje</label>
                    <textarea rows={4} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Escribe tu mensaje aqui..."></textarea>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                <img src="/logo-uhr.png" alt="United for Human Rights" className="w-12 h-12 object-contain" />
                <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-md">
                Capitulo autorizado en Colombia de Unidos por los Derechos Humanos, organizacion internacional dedicada a la educacion sobre derechos humanos.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-500 text-sm">
              &copy; {new Date().getFullYear()} Unidos por los Derechos Humanos - Capitulo Colombia. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
