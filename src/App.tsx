...
function App() {
  ...
  const [formEnviado, setFormEnviado] =
  ...
  const afichesList = [
...

    {
      ...
      title:
        ...
        'Derechos Humanos - Art. 20 #2',

      file: 'afiche-20-2.png',
  ...
  const handleFormSubmit = async (
    ...
    + `%0D%0ATipo de Documento: ${formData.tipoDocumento}

    + `%0D%0ADocumento: ${formData.documento}

    + `%0D%0AEmail: ${formData.email}

    + `%0D%0ATelefono: ${formData.telefono}

    + `%0D%0ACiudad: ${formData.ciudad}

    + `%0D%0ADepartamento: ${formData.departamento}

    + `%0D%0AOcupacion: ${formData.ocupacion}
    ...
    <div className="min-h-screen bg-white relative">
            ...
            <div className="px-4 py-4 space-y-3">
              ...
              {[
                ...
                <button
                  ...
                  className="block w-full text-left px-3 "
                    + "py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 "
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-blue-900/90 "
            + "via-blue-800/80 to-transparent""></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <div className="inline-flex items-center px-4 py-2 "
                + "bg-yellow-500/30 border-2 border-yellow-400 rounded-full "
                + "mb-6"">
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                ...
                Educando y empoderando a

                las comunidades

                colombianas sobre sus
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-400 "
                    + "hover:to-yellow-300 text-blue-900 font-bold px-8 "
                    + "py-6 text-lg shadow-lg""
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 "
                    + "hover:to-purple-400 text-white font-bold px-8 "
                    + "py-6 text-lg shadow-lg""
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 "
                    + "hover:to-blue-400 text-white font-bold px-8 "
                    + "py-6 text-lg shadow-lg""
              ...
              <div className="mt-4">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-green-500 to-emerald-400 hover:from-green-400 "
                    + "hover:to-emerald-300 text-white font-bold px-8 "
                    + "py-6 text-lg shadow-lg w-full "
                    + "sm:w-auto animate-pulse""
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 "
                      + "bg-white/95 backdrop-blur rounded-xl text-gray-800 "
            ...
            <div className="hidden lg:flex justify-center">
              ...
              <img
                ...
                className="w-80 h-80 object-contain rounded-full "
                  + "shadow-2xl border-4 border-yellow-400/50""
        ...
        <div className="absolute bottom-8 left-1/2 transform "
          ...
          <div className="w-6 h-10 border-2 border-white/50 "
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="inline-flex items-center px-4 py-2 "
                + "bg-yellow-100 rounded-full mb-6"">
              ...
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                ...
                La Fundación capítulo

                Unidos por los Derechos

                Humanos Colombia, y su

                movimiento "Unidos

                haremos de Colombia y el

                mundo un mejor lugar

                para vivir", se

                consolidan como un eje
              ...
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                ...
                apoyo estratégica, que

                integra organizaciones

                aliadas y mecanismos de

                veeduría en diversos

                ámbitos, garantizamos
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                ...
                real que, mediante la

                cooperación técnica y el

                empoderamiento social,

                trabaja para que las
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="w-10 h-10 bg-yellow-100 rounded-lg "
                    + "flex items-center justify-center flex-shrink-0"">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-gradient-to-br "
                + "from-yellow-500 to-yellow-600 text-white p-6 "
      ...
      <section
        ...
        className="py-16 bg-gradient-to-br from-sky-400 via-sky-500 "
          + "to-blue-500""
            ...
            <div className="flex justify-center">
              ...
              <div className="relative">
                ...
                <div className="w-64 h-64 md:w-80 md:h-80 "
                  + "bg-white rounded-full p-4 shadow-2xl "
                ...
                <div className="absolute -bottom-4 left-1/2 transform "
                  + "-translate-x-1/2 bg-white px-6 py-2 "
      ...
      <section className="py-16 bg-gradient-to-br from-yellow-600 via-yellow-500 "
        + "to-yellow-400"">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            ...
            <div className="mt-6 inline-flex items-center px-6 "
              + "py-3 bg-white/20 backdrop-blur rounded-full"">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="bg-white/10 backdrop-blur border-white/20">
              ...
              <CardHeader>
                ...
                <div className="w-14 h-14 bg-gradient-to-br from-yellow-400 "
                  + "to-yellow-600 rounded-xl flex items-center "
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              ...
              <CardContent className="p-8 text-center">
                ...
                <div className="w-32 h-32 mx-auto mb-6 "
                  + "bg-white rounded-full shadow-lg flex "
                ...
                <a
                  ...
                  className="inline-flex items-center px-3 py-1.5 "
                    + "bg-green-600 text-white text-sm rounded-full "
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              ...
              <CardContent className="p-8 text-center">
                ...
                <a
                  ...
                  className="inline-flex items-center px-3 py-1.5 "
                    + "bg-blue-600 text-white text-sm rounded-full "
                ...
                d={
                  ...
                  'M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c'

                  + '0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.'

                  + '47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.31'

                  + '2 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956'

                  + '.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.38'

                  + '5C19.612 23.027 24 18.062 24 12.073z'
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              ...
              <CardContent className="p-8 text-center">
                ...
                <div className="flex justify-center gap-3">
                  ...
                  <a
                    ...
                    className="inline-flex items-center px-3 py-1.5 "
                      ...
                      + "text-sm rounded-full hover:opacity-90 transition-opacity""
                ...
                d={
                  ...
                  'M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.77'

                  + '1 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 '

                  + '0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.7'

                  + '71-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-'

                  + '3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4'

                  + '.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.5'

                  + '83.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.26'

                  + '6-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.6'

                  + '67.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059'

                  + ' 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072'

                  + ' 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.68'

                  + '9.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.35'

                  + '4-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073'

                  + '-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.'

                  + '617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.07'

                  + '3zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 '

                  + '6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-'

                  + '2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-'

                  + '4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4'

                  + '-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.6'

                  + '45 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.'
              ...
              <CardContent className="p-8 text-center">
                ...
                <div className="flex justify-center gap-2 flex-wrap">
                  ...
                  <a
                    ...
                    className="inline-flex items-center px-3 py-1.5 "
                      + "bg-blue-800 text-white text-sm rounded-full "
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              ...
              <CardContent className="p-8 text-center">
                ...
                <a
                  ...
                  className="inline-flex items-center px-3 py-1.5 "
                    + "bg-amber-600 text-white text-sm rounded-full "
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              ...
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  ...
                  como acción para la no

                  repetición de hechos

                  que marcaron a la

                  población, preservando
            ...
            {[
...

              {
                ...
                title:
                  ...
                  'Derecho #1: Nacemos Libres e Iguales',
              ...
              <Card
                ...
                className="overflow-hidden hover:shadow-xl transition-shadow border-0 "
                  + "shadow-md""
              ...
              <div className="flex items-center gap-4">
                ...
                <img
                  ...
                  className="w-20 h-20 rounded-full object-cover "
                    + "border-2 border-white/30 shadow-lg flex-shrink-0""
            ...
            {[
...

              {
                ...
                title:
                  ...
                  'Guía Defensa Embargos Ilegales',
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <div className="inline-flex items-center px-4 py-2 "
              + "bg-purple-100 rounded-full mb-4"">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              ...
              Tu aporte nos permite

              continuar educando y

              empoderando comunidades

              sobre sus derechos

              humanos. Cada contribucion
            ...
            <CardContent className="p-6">
              ...
              >
                ...
                <div className="bg-gray-100 rounded-lg p-4 mb-4 "
                  + "text-center hover:bg-gray-200 transition-colors cursor-pointer"">
              ...
              >
                ...
                <div className="bg-green-500 rounded-lg p-4 hover:bg-green-600 "
                  + "transition-colors cursor-pointer text-center text-white"">
                ...
                >
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-blue-600 to-blue-700 "
                      + "hover:from-blue-700 hover:to-blue-800 text-white py-4 "
                      + "text-lg font-bold""
            ...
            {[
...

              {
                ...
                title:
                  ...
                  'Formato Observación Procedimiento',
...

              {
                ...
                description:
                  ...
                  'Ejemplo práctico de derecho de petición',
...

              {
                ...
                description:
                  ...
                  'Ejemplo práctico de acción de tutela',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md "
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  ...
                  Hubbard. Descubre los

                  preceptos para vivir
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md "
              ...
              <div className="h-48 bg-gradient-to-br from-cyan-600 to-blue-700 "
                + "flex items-center justify-center"">
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md "
              ...
              <div className="h-48 bg-gradient-to-br from-yellow-500 to-red-600 "
                + "flex items-center justify-center"">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {[
              ...
              >
                ...
                <Card className="bg-white/10 backdrop-blur border-white/20 hover:bg-white/20 "
            ...
            <div className="space-y-8">
              ...
              <Card className="border-0 shadow-md">
                ...
                d={
                  ...
                  + '3-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.16'

                  + '4-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2'

                  + '.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.2'

                  + '97-.018-.458.13-.606.134-.133.298-.347.446-.52.149'

                  + '-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-'

                  + '.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-'

                  + '.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074'

                  + '-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1'

                  + '.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.4'

                  + '87.709.306 1.262.489 1.694.625.712.227 1.36.195 1.'

                  + '871.118.571-.085 1.758-.719 2.006-1.413.248-.694.2'

                  + '48-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5'

                  + '.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-'

                  + '.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-'

                  + '1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0'

                  + ' 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.99'

                  + '4c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A'

                  + '11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11'

                  + '.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1'

                  + '.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11'

                  + '.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.'
              ...
              <Card className="border-0 shadow-md">
                ...
                d={
                  ...
                  'M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.6'

                  + '7a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.'

                  + '64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.0'

                  + '5A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.4'

                  + '3v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 '
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-md">
                ...
                Capítulo autorizado en

                Colombia de Unidos por
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm "
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
            ...
            <div className="text-center mb-6">
              ...
              <div className="w-14 h-14 bg-purple-100 rounded-full "
                + "flex items-center justify-center mx-auto "
                + "mb-4"">
        ...
        >
          ...
          <button
            ...
            className="absolute top-4 right-4 w-12 "
              + "h-12 bg-white/10 hover:bg-white/20 rounded-full "
          ...
          <div
            ...
            className="max-w-4xl max-h-[85vh] w-full flex "
          ...
          >
            ...
            <a
              ...
              className="mt-4 inline-flex items-center px-6 "
                + "py-2 bg-purple-600 hover:bg-purple-700 text-white "
