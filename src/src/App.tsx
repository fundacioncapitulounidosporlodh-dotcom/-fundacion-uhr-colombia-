...
function App() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    const sections = [
      ...
      { id: 'descargas', keywords: ['descargas', 'manual', 'materiales', 'pdf', 'descargar', 'bajar', 'archivos', 'cartilla', 'niÃ±o', 'participacion ciudadana', 'embargos', 'sentencia'] },
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              {[
                ...
                { name: 'AfiliaciÃ³n', id: 'afiliacion' },
                { name: 'CapacÃ­tate', id: 'capacitate' },
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="inline-flex items-center px-4 py-2 bg-yellow-500/30 border-2 border-yellow-400 rounded-full mb-6">
              ...
              <span className="text-yellow-300 text-sm font-medium">CAPITULO AUTORIZADO EN COLOMBIA - TEST123</span>
            </div>
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              ...
              Parte de la organizaciÃ³n internacional con sede en Estados Unidos.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                CapÃ­tulo Colombia de<br />
                <span className="text-yellow-600">Unidos por los Derechos Humanos</span>
              </h2>
              
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                La FundaciÃ³n capÃ­tulo Unidos por los Derechos Humanos Colombia, y su movimiento 
                "Unidos haremos de Colombia y el mundo un mejor lugar para vivir", se consolidan 
                como un eje de articulaciÃ³n ciudadana para la protecciÃ³n de la dignidad humana.
              </p>
              
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                A travÃ©s de una red de apoyo estratÃ©gica, que integra organizaciones aliadas y 
                mecanismos de veedurÃ­a en diversos Ã¡mbitos, garantizamos una presencia efectiva 
                en la defensa y educaciÃ³n de los Derechos Humanos.
              </p>

              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Nuestra labor trasciende la teorÃ­a: somos una plataforma de incidencia real que, 
                mediante la cooperaciÃ³n tÃ©cnica y el empoderamiento social, trabaja para que las 
                garantÃ­as fundamentales sean el pilar de la convivencia en nuestro territorio y 
                un referente de transformaciÃ³n global.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">EducaciÃ³n sobre derechos universales</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
            ...
            <div className="relative">
              <img 
                ...
                alt="EducaciÃ³n en Derechos Humanos" 
              ...
              <div className="absolute -bottom-6 -left-6 bg-gradient-to-br from-yellow-500 to-yellow-600 text-white p-6 rounded-xl shadow-lg">
                ...
                <div className="text-yellow-100">CapÃ­tulo Autorizado</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center px-4 py-2 bg-white/20 rounded-full mb-6">
                ...
                <span className="text-white text-sm font-medium">MembresÃ­a Oficial</span>
              </div>
              
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
                Consejo Territorial de Paz, ReconciliaciÃ³n y Convivencia
              </h2>
              <p className="text-xl text-sky-100 mb-4">
                Santiago de Cali
              </p>
              <p className="text-sky-50 text-lg mb-4 leading-relaxed">
                Hacemos parte del Consejo Territorial de Paz, ReconciliaciÃ³n y Convivencia de Santiago de Cali 
                <span className="font-bold text-white"> en representaciÃ³n de la FundaciÃ³n Ãrbol Fuente de Vida</span>, 
                trabajando conjuntamente por la construcciÃ³n de paz, la reconciliaciÃ³n y la convivencia ciudadana en nuestra ciudad.
              </p>
              <div className="flex flex-wrap gap-3">
                <div className="inline-flex items-center px-4 py-2 bg-white/20 rounded-full">
                  <Heart className="w-4 h-4 text-white mr-2" />
                  <span className="text-white text-sm">ConstrucciÃ³n de Paz</span>
                </div>
                <div className="inline-flex items-center px-4 py-2 bg-white/20 rounded-full">
                  <Users className="w-4 h-4 text-white mr-2" />
                  <span className="text-white text-sm">ReconciliaciÃ³n</span>
                </div>
                <div className="inline-flex items-center px-4 py-2 bg-white/20 rounded-full">
                  <Scale className="w-4 h-4 text-white mr-2" />
              ...
              <div className="relative">
                <div className="w-64 h-64 md:w-80 md:h-80 bg-white rounded-full p-4 shadow-2xl flex items-center justify-center">
                  <img 
                    ...
                    alt="Escudo Consejo Territorial de Paz, ReconciliaciÃ³n y Convivencia de Santiago de Cali" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-yellow-100 mb-2">
              <span className="font-semibold">OrganizaciÃ³n Internacional</span> con sede en Estados Unidos
            </p>
            <p className="text-lg text-yellow-50 max-w-3xl mx-auto">
              CapÃ­tulo Colombia autorizado oficialmente. Utilizamos los logos, colores y materiales 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-white/10 backdrop-blur border-white/20">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-white">Nuestra MisiÃ³n</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-blue-100 leading-relaxed">
                  Educar y empoderar a las comunidades colombianas sobre sus derechos humanos 
                  fundamentales, utilizando los recursos oficiales de la organizaciÃ³n internacional 
                  Unidos por los Derechos Humanos, para construir una sociedad mÃ¡s justa, 
            ...
            <Card className="bg-white/10 backdrop-blur border-white/20">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-white">Nuestra VisiÃ³n</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-blue-100 leading-relaxed">
                  Ser el referente principal en educaciÃ³n de derechos humanos en Colombia, 
                  alcanzando todas las regiones del paÃ­s con materiales educativos de calidad, 
                  formando una ciudadanÃ­a informada que defienda activamente los derechos 
                  humanos para todos.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">Fortalecer el tejido social generando confianza y bienestar de todos los sectores de la sociedad, ofreciendo servicios con altos estÃ¡ndares de calidad para el desarrollo social y econÃ³mico comunitario.</p>
                <a 
            ...
            {/* NGO CAPEHALCONES / FundaciÃ³n Hawks */}
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                <div className="w-32 h-32 mx-auto mb-6 bg-white rounded-full shadow-lg flex items-center justify-center overflow-hidden">
                  <img 
                ...
                <p className="text-gray-600 text-sm mb-4">OrganizaciÃ³n no gubernamental dedicada a la protecciÃ³n y promociÃ³n de los derechos humanos, trabajando por la justicia social y el bienestar de las comunidades vulnerables.</p>
                <a 
            ...
            {/* VeedurÃ­a Ciudadana de la NaciÃ³n Cali */}
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                <div className="w-32 h-32 mx-auto mb-6 bg-white rounded-full shadow-lg flex items-center justify-center overflow-hidden">
                  <img 
                    src="/logo-veeduria-nacion.jpg" 
                    alt="VeedurÃ­a Ciudadana de la NaciÃ³n Cali" 
                    className="w-28 h-28 object-contain"
                  />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">VeedurÃ­a Ciudadana de la NaciÃ³n Cali</h3>
                <p className="text-gray-600 text-sm mb-4">VeedurÃ­a ciudadana facultada por la Ley 850 de 2003 para el control social, vigilancia y seguimiento de la gestiÃ³n pÃºblica, promoviendo la transparencia y el buen uso de los recursos pÃºblicos.</p>
                <a 
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">Sindicato de AcciÃ³n Comunal de Colombia - OrganizaciÃ³n que promueve el fortalecimiento de las organizaciones comunales y la participaciÃ³n ciudadana en la construcciÃ³n de tejido social.</p>
            ...
            {/* FundaciÃ³n El Camino de la Felicidad */}
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                <div className="w-32 h-32 mx-auto mb-6 bg-white rounded-full shadow-lg flex items-center justify-center overflow-hidden">
                  <img 
                    src="/logo-camino-felicidad.jpg" 
                    alt="FundaciÃ³n El Camino de la Felicidad" 
                    className="w-28 h-28 object-contain"
                  />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">FundaciÃ³n El Camino de la Felicidad</h3>
                <p className="text-gray-600 text-sm mb-4">Revertir la decadencia moral de la sociedad al restaurar la confianza y honestidad a travÃ©s de la distribuciÃ³n amplia del libro "El Camino a la Felicidad", una guÃ­a basada en el sentido comÃºn para vivir mejor.</p>
                <a 
            ...
            {/* FundaciÃ³n por un Mundo Libre de Drogas */}
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                <div className="w-32 h-32 mx-auto mb-6 bg-white rounded-full shadow-lg flex items-center justify-center overflow-hidden">
                  <img 
                    src="/logo-drug-free-world.jpg" 
                    alt="FundaciÃ³n por un Mundo Libre de Drogas" 
                    className="w-28 h-28 object-contain"
                  />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">FundaciÃ³n por un Mundo Libre de Drogas</h3>
                <p className="text-gray-600 text-sm mb-4">Proporcionar informaciÃ³n basada en hechos acerca de las drogas para que las personas puedan tomar decisiones informadas y vivir una vida libre de drogas, mediante educaciÃ³n y prevenciÃ³n efectiva.</p>
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">Centro de Pensamiento y DiÃ¡logo PolÃ­tico - Promover el avance en estudios e investigaciones para contribuir a la construcciÃ³n de una sociedad fundamentada en valores de democracia, justicia social e igualdad.</p>
                <a 
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">Memoria Viva Colombia - Visibilizar las vÃ­ctimas y realizar ejercicios de memoria como acciÃ³n para la no repeticiÃ³n de hechos que marcaron a la poblaciÃ³n, preservando la memoria histÃ³rica del paÃ­s.</p>
                <div className="flex justify-center gap-3">
                  <a 
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">Sindicato de Trabajadores de la Justicia y la Paz - Promover y defender la paz como derecho fundamental, asÃ­ como los derechos humanos y laborales de todas las trabajadoras y trabajadores.</p>
                <div className="flex justify-center gap-3">
                  <a 
      ...
      <section id="videos" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Contenido audiovisual oficial de Unidos por los Derechos Humanos en espaÃ±ol
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Video completo con los 30 derechos humanos en espaÃ±ol latino',
                videoId: 'Lp6wEaivQVY'
              },
              {
              ...
              },
              {
                ...
                description: 'Todos tienen los mismos derechos sin distinciÃ³n de ningÃºn tipo',
                videoId: 'n0WfKHaNfA0'
              },
              {
              ...
              },
              {
                ...
                description: 'Nadie estarÃ¡ sometido a esclavitud ni a servidumbre',
                videoId: '4-a4sEZ1fK0'
              },
              {
                title: 'Derecho #5: Ninguna Tortura',
                description: 'Nadie serÃ¡ sometido a torturas ni a penas o tratos crueles',
                videoId: '_8YfmW6Jv4U'
              }
            ].map((video, index) => (
            ...
            {[
              {
                ...
                description: 'GuÃ­a completa sobre los 30 derechos humanos en espaÃ±ol',
                type: 'PDF',
                size: '3.4 MB',
                color: 'bg-red-500',
              ...
              {
                title: 'Cartilla de Derechos del NiÃ±o',
                description: 'Material educativo sobre derechos de niÃ±os, niÃ±as y adolescentes',
                type: 'PDF',
                size: '1.8 MB',
                color: 'bg-blue-500',
              ...
              {
                title: 'Manual de ParticipaciÃ³n Ciudadana',
                description: 'GuÃ­a completa para la participaciÃ³n ciudadana y veedurÃ­a',
                type: 'PDF',
                size: '13.1 MB',
                color: 'bg-teal-500',
              ...
              {
                title: 'GuÃ­a Defensa Embargos Ilegales',
                description: 'GuÃ­a prÃ¡ctica para la defensa contra embargos ilegales',
                type: 'PDF',
                size: '73 KB',
                color: 'bg-amber-600',
              ...
              {
                title: 'Manual de VeedurÃ­as',
                description: 'GuÃ­a sobre el ejercicio de veedurÃ­a ciudadana, control social y derechos humanos',
                type: 'PDF',
                size: '13.7 MB',
                color: 'bg-purple-600',
            ...
            <CardContent className="p-8">
              {formEnviado ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Â¡Gracias por tu interes!</h3>
                ...
                <form onSubmit={handleFormSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Â¿Por que deseas afiliarte? *</label>
                    <textarea name="motivo" value={formData.motivo} onChange={handleFormChange} required rows={3}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="CuÃ©ntanos tu motivacion para unirte..."></textarea>
                  </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[ 
              ...
              },
              {
                ...
                description: 'Formulario para solicitar alianza estratÃ©gica con nuestra fundaciÃ³n',
                format: 'PDF',
              ...
              {
                title: 'Formato Derecho de PeticiÃ³n',
                description: 'Modelo para ejercer el derecho de peticiÃ³n constitucional',
                format: 'PDF',
                url: '/formato-derecho-peticion.pdf'
              },
              {
                title: 'Formato ObservaciÃ³n Procedimiento',
                description: 'Formato para observar procedimientos administrativos',
                format: 'PDF',
                url: '/formato-observacion-procedimiento.pdf'
              },
              {
                title: 'Modelo de PeticiÃ³n',
                description: 'Ejemplo prÃ¡ctico de derecho de peticiÃ³n',
                format: 'PDF',
                url: '/modelo-de-peticion-1.pdf'
              },
              {
                title: 'Modelo de Tutela',
                description: 'Ejemplo prÃ¡ctico de acciÃ³n de tutela',
                format: 'PDF',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-yellow-100 rounded-full mb-4">
              ...
              <span className="text-yellow-700 text-sm font-medium">CapacitaciÃ³n</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              CapacÃ­tate
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  InformaciÃ³n veraz sobre los efectos de las drogas. Curso educativo gratuito.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-green-600 font-medium">Gratuito</span>
                  <a 
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Cursos gratuitos de la OrganizaciÃ³n Panamericana de la Salud sobre derechos humanos y salud.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-green-600 font-medium">Gratuito</span>
                  <a 
            ...
            {/* Aula Virtual DefensorÃ­a del Pueblo */}
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md overflow-hidden">
              <div className="h-48 bg-gradient-to-br from-indigo-600 to-purple-700 flex items-center justify-center">
                <div className="text-center text-white">
                  ...
                  <p className="text-lg font-bold">DefensorÃ­a del Pueblo</p>
                </div>
              </div>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Aula Virtual DefensorÃ­a del Pueblo</h3>
                <p className="text-gray-600 text-sm mb-4">
                  Plataforma gratuita de la DefensorÃ­a del Pueblo de Colombia para capacitaciÃ³n en derechos humanos.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-green-600 font-medium">Gratuito</span>
                  <a 
            ...
            <Card className="hover:shadow-xl transition-shadow border-0 shadow-md overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Escuela Superior de AdministraciÃ³n PÃºblica - Cursos gratuitos de formaciÃ³n en derechos humanos y administraciÃ³n pÃºblica.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-green-600 font-medium">Gratuito</span>
                  <a 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description: 'CapacitaciÃ³n gratuita',
      ...
      <section id="contacto" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Estamos aquÃ­ para ayudarte. EscrÃ­benos o visÃ­tanos en nuestras oficinas.
            </p>
          </div>
              ...
              <Card className="border-0 shadow-md">
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">Correo ElectrÃ³nico</h3>
              ...
              <Card className="border-0 shadow-md">
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">TelÃ©fono / WhatsApp</h3>
              ...
              <Card className="border-0 shadow-md">
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">DirecciÃ³n</h3>
                ...
                <form className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      type="text" 
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="Â¿Sobre quÃ© nos quieres contactar?"
                    />
                  </div>
                  <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">CapÃ­tulo Colombia</p>
                </div>
              </div>
              <p className="text-gray-400 text-sm leading-relaxed max-w-md">
                CapÃ­tulo autorizado en Colombia de Unidos por los Derechos Humanos, 
                organizaciÃ³n internacional dedicada a la educaciÃ³n sobre derechos humanos.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="https://www.humanrights.com/course/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Curso en lÃ­nea</a></li>
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-500 text-sm">
              Â© {new Date().getFullYear()} Unidos por los Derechos Humanos - CapÃ­tulo Colombia. 
